...
import CardFourPlacholder from "../../images/third.jpg";
import CardTwoPlacholder from "../../images/prenental.jpg";


function FeatureProduct() {
    return (
       <div className="featured-products-container flex flex-col justify-center ">
      <div className="featured-product-header  mx-24 flex justify-between items-center p-2 text-ritual-blue">
        <span className="text-4xl ">Featured Products</span>
        <span className="underline cursor-pointer">Shop all</span>
      </div>
      <div className="name mx-16 flex">
        <FeaturedProductCard
          for="Women"
        ...
        <FeaturedProductCard
          ...
          cardPlaceholder={CardTwoPlacholder}
        />
        <FeaturedProductCard
          for="Protein"
          type="Daily Shake 18+"
        ...
        <FeaturedProductCard
          ...
          cardPlaceholder={CardFourPlacholder}
        />
      </div>
    </div>
  );
